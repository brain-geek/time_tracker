  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved time_entry as @time_entry" do
        ...
        post :create, {:time_entry => { "started_at" => "invalid value" }}, valid_session
        assigns(:time_entry).should be_a_new(TimeEntry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested time_entry" do
        ...
        TimeEntry.any_instance.should_receive(:update).with({ "started_at" => "2014-02-07 17:39:49" })
        put :update, {:id => time_entry.to_param, :time_entry => { "started_at" => "2014-02-07 17:39:49" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the time_entry as @time_entry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TimeEntry.any_instance.stub(:save).and_return(false)
        put :update, {:id => time_entry.to_param, :time_entry => { "started_at" => "invalid value" }}, valid_session
        assigns(:time_entry).should eq(time_entry)
      end
